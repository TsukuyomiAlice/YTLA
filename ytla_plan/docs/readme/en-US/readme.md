...
|--------------|---------------------------------------|-------------------|--------------------------|
| docs         | Component Configuration Documentation | .yaml, .json, .py | For automatic generation |
...
| script       | Call Script                 | .py       | Assemble and call methods or functions within the package |
...
| api          | External API Calls                         | .py       | Send API requests and process API reception results                 |
| ai_tools     | AI Assistant Tools                         | .py       | Specific function code snippets that need to be processed by Gen AI |
| caller       | Cross-package Function Call Unified Method | .py       | Cross-package calling function                                      |
...
| Package Name | File Function | File Type | Description                  |
|--------------|---------------|-----------|------------------------------|
| routes       | API Routes    | .py       | python-flask Blueprint files |

### Configuration

| Package Name | File Function            | File Type        | Description                        |
|--------------|--------------------------|------------------|------------------------------------|
| utils        | Configuration Parameters | .py, .json, etc. | Operation configuration parameters |