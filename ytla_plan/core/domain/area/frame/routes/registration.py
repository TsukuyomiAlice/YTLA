def register_all_blueprints(app):
    from core.domain.area.frame.routes.routeUpload import upload_bp
    from core.domain.area.frame.routes.routeGlobalPersistence import globalPersistence_bp
    from core.domain.area.cards.routes.routeCards import cards_bp
    from core.domain.area.plans.routes.routePlans import plans_bp
    from core.domain.area.modules.routes.routeModules import modules_bp
