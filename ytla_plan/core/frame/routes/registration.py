def register_all_blueprints(app):
    ...
    from features.language.routes.routeModuleAssessment import language_assessment_bp
    from features.language.routes.routeModuleDictionary import language_dictionary_bp
    from features.language.routes.routeModuleVocabulary import language_vocabulary_bp
