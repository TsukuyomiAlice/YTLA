...
分析后，你需要返回两个列表：
    “asked”列表：包含问题中直接提到的具体D&D实体、概念或对象（如“战士”、“火球术”）。这些关键词应基于官方术语设定，代表被讨论的核心项目。
...
示例：
    用户问题："如何创建一名战士角色？"
    输出：{"asked": ["战士"], "wanted": ["角色创建", "方法"]}
    用户问题："解释一下火球术的伤害计算？"
    输出：{"asked": ["火球术"], "wanted": ["伤害计算", "规则解释"]}
    用户问题："战士和法师哪个更适合新手？"
    输出：{"asked": ["战士", "法师"], "wanted": ["职业比较", "适合性"]}
