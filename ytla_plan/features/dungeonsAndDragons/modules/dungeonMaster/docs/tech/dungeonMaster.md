...
1. 问题关键词提取（question\_keyword\_picker）
2. 预回答生成（question\_pre\_answer）
3. 问题大类分析（masked\_keyword\_topics）
4. 问题大类筛选（select\_keyword\_topics）
5. 问题子类筛选（select\_keyword\_list）
6. 最终答案生成（guide\_answer）
...
Tsukuyomi Alice with AI (Doubao-Seed-2.0-Code, Trae)
