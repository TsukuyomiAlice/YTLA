...
topics = {
    "Preface": [
        "Preface", "Introduction", "World_of_Adventure", "Using_This_Book", "How_to_play", "Game_Dice",
        "Specific_Beats_General", "Round_Down", "Adventures", "The_Wonders_of_Magic",],
}
