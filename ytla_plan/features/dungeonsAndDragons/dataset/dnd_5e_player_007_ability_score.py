...
ability_article = {
    ...
    "Intelligence": Intelligence_check_prompt,
    "Wisdom": Wisdom_check_prompt,
    "Charisma": Charisma_check_prompt,
    "Saving_throws": Saving_throws_prompt,
}
