...
spells_article = """
# 第 11 章：法术 Spells
本章将详述 D&D 世界里最常见的一些法术。章节的开头部分是各施法职业的法术列表。列表后则是按法术名字头字母顺序排列的法术详述内容。
"""
...
# table 活化物件属性资料 Animated Object Statistics
体型 HP AC 攻击 力量 敏捷
...
枯水 Destroy Water。你使施法距离内一个打开的容器里的 10 加仑水分枯竭不见。或者使施法距离内一片 30 尺立方区域的浓雾消失不见。
