...
改变风势时，你还可以同时改变其风向。
降水 Precipitation等级 状况1 天晴 clear2 薄云 light clouds3 多云 overcast 或有雾 ground fog4 有雨 rain，冰雹 hail 或有雪 snow5 暴雨 torrential rain，冰暴 driving hail 或暴雪 blizzard气温 Temperature等级 状况1 酷热 unbearable heat2 炎热 hot3 暖和 warm4 清凉 cool5 寒冷 cold6 极寒 arctic cold风势 Wind等级 状况1 无风 calm2 和风 moderate wind3 强风 strong wind4 狂风 gale5 暴风 strom
...
### 法术成分：V
### 持续时间：至多 1 分钟
你在施法距离内展示出一个低级奇观，以表现你的超自然力。你在施法距离内创造出下列魔法效应之一：• 你的声音在 1 分钟内变得比常人响两倍。
...
spell_article = {
    "Bard_spells": spell_descriptions_list,
    "Cleric_spells": spell_descriptions_list,
    "Druid_spells": spell_descriptions_list,
    "Paladin_Spells": spell_descriptions_list,
    "Ranger_spells": spell_descriptions_list,
    "Sorcerer_spells": spell_descriptions_list,
