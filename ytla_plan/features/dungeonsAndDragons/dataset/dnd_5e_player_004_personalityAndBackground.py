...
personality_background_article = {
    ...
    "Entertainer": Entertainer_prompt,
    "Folk_hero": Folk_hero_prompt,
    "Guild_artisan": Guild_artisan_prompt,
    "Hermit": Hermit_prompt,
    "Noble": Noble_prompt,
    "Outlander": Outlander_prompt,
    "Sage": Sage_prompt,
    "Sailor": Sailor_prompt,
    "Soldier": Soldier_prompt,
    "Urchin": Urchin_prompt,
}
