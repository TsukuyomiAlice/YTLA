...
def generate(target_path, type_name, sub_type_name):
    """
    Generate script directory and __init__.py file
    ...
    script_dir = os.path.join(target_path, "script")
    File.create_directory_if_not_exists(script_dir)
    
    # Create __init__.py file
    init_file = os.path.join(script_dir, "__init__.py")
    File.create_init_file(init_file)
    
    print(f"Generated script directory structure at: {script_dir}")
