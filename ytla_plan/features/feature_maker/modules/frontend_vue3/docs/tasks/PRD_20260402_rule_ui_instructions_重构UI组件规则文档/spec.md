...
* **Summary**: 对现有的 rule\_ui\_instructions.md 文档进行重构，补充重构已存在UI元件的指示和类型定义导入的清晰说明
...
当前 rule\_ui\_instructions.md 文档提供了完整的新建UI元件规范，但在以下方面存在不足：
...
* **Given**: 打开 rule\_ui\_instructions.md 文档
