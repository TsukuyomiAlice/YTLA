datas = [
    ["cattle", "", "B1", "noun", "animals"],
    ["clothes", "", "A1", "noun", "clothes"],
    ["albeit", "", "C2", "conjunction", ""],
    ["and", "ALSO", "A1", "conjunction", "communication"],
    ["and", "AFTER", "A1", "conjunction", "communication"],
    ["because", "", "A1", "conjunction", "communication"],
    ["but", "DIFFERENT STATEMENT", "A1", "conjunction", "communication"],
    ["and", "AFTER VERB", "A2", "conjunction", "communication"],
    ["as", "BECAUSE", "A2", "conjunction", "communication"],
    ["although", "BUT", "B1", "conjunction", "communication"],
    ["although", "DESPITE", "B1", "conjunction", "communication"],
    ["and", "EMPHASIZE", "B1", "conjunction", "communication"],
    ["close", "", "B1", "adverb", "describing things"],
    ["as", "JOB", "A1", "conjunction", "work"],
    ["and", "NUMBERS", "A1", "conjunction", ""],
    ["as", "USE", "A2", "conjunction", ""],
    ["before", "EARLIER", "A2", "conjunction", ""],
    ["after", "", "B1", "conjunction", ""],
    ["as", "BEING OR APPEARING", "B1", "conjunction", ""],
    ["as", "WHILE", "B1", "conjunction", ""],
    ["as", "LIKE", "B1", "conjunction", ""],
    ["before", "TO AVOID SOMETHING", "B1", "conjunction", ""],
    ["before", "UNTIL", "B1", "conjunction", ""],
    ["but", "EXPLAINING WHY", "B1", "conjunction", ""],
    ["eight", "", "A1", "number", ""],
    ["eighteen", "", "A1", "number", ""],
    ["eleven", "", "A1", "number", ""],
    ["eighth", "", "A2", "number", ""],
    ["eighty", "", "A2", "number", ""],
    ["insofar as", "", "C2", "conjunction", ""],
    ["fifteen", "", "A1", "number", ""],
    ["five", "", "A1", "number", ""],
    ["four", "", "A1", "number", ""],
    ["fourteen", "", "A1", "number", ""],
    ["fifth", "", "A2", "number", ""],
    ["fifty", "", "A2", "number", ""],
    ["forty", "NUMBER", "A2", "number", ""],
    ["fourth", "", "A2", "number", ""],
    ["hundred", "NUMBER", "A2", "number", ""],
    ["if", "DEPENDING", "A2", "conjunction", ""],
    ["if", "ALWAYS", "B1", "conjunction", ""],
    ["if", "MIGHT", "B1", "conjunction", ""],
    ["if", "WHETHER", "B1", "conjunction", ""],
    ["if", "WOULD/MIGHT/COULD HAVE", "B2", "conjunction", ""],
    ["however", "", "C2", "conjunction", ""],
    ["million", "NUMBER", "A2", "number", ""],
    ["like", "", "B1", "conjunction", ""],
    ["or", "POSSIBILITIES", "A1", "conjunction", "communication"],
    ["or", "NOT EITHER", "A2", "conjunction", "communication"],
    ["or", "WARNING", "B1", "conjunction", "communication"],
    ["or", "CHANGE", "B2", "conjunction", "communication"],
    ["only", "", "C2", "conjunction", "communication"],
    ["nine", "", "A1", "number", ""],
    ["nineteen", "", "A1", "number", ""],
    ["one", "", "A1", "number", ""],
    ["ninety", "NUMBER", "A2", "number", ""],
    ["ninth", "", "A2", "number", ""],
    ["now", "", "B2", "conjunction", ""],
    ["once", "", "B2", "conjunction", ""],
    ["or", "REASON", "C1", "conjunction", ""],
    ["provided (that)", "", "B2", "conjunction", "communication"],
    ["second", "ANOTHER", "B1", "number", "describing things"],
    ["politically", "", "C1", "adverb", ""],
    ["second", "AFTER FIRST", "A1", "number", ""],
    ["plus", "", "B1", "conjunction", ""],
    ["second", "ONLY ONE BETTER/BIGGER, ETC.", "B1", "number", ""],
    ["seventy", "", "A2", "number", ""],
    ["so", "SENTENCE BEGINNING", "A2", "conjunction", "communication"],
    ["seven", "", "A1", "number", ""],
    ["seventeen", "", "A1", "number", ""],
    ["six", "", "A1", "number", ""],
    ["sixteen", "", "A1", "number", ""],
    ...
    ["thirteen", "", "A1", "number", ""],
    ["three", "", "A1", "number", ""],
    ["to", "INFINITIVE", "A1", "preposition", ""],
    ["seventh", "", "A2", "number", ""],
    ["sixth", "", "A2", "number", ""],
    ["sixty", "", "A2", "number", ""],
    ["so", "REASON", "A2", "conjunction", ""],
    ["that", "", "A2", "conjunction", ""],
    ["third", "", "A2", "number", ""],
    ["thirty", "", "A2", "number", ""],
    ["thousand", "NUMBER", "A2", "number", ""],
    ["to", "REASON", "A2", "conjunction", ""],
    ["to", "INSTEAD OF VERB", "A2", "conjunction", ""],
    ["since", "TIME", "B1", "conjunction", ""],
    ["since", "BECAUSE", "B1", "conjunction", ""],
    ["though", "DESPITE", "B1", "conjunction", ""],
    ["till", "", "B1", "conjunction", ""],
    ["though", "BUT", "B2", "conjunction", ""],
    ["zero", "NUMBER", "A2", "number", ""],
    ["while", "ALTHOUGH", "B2", "conjunction", "communication"],
    ["while", "COMPARING", "B1", "conjunction", "communication"],
    ["whereas", "", "B2", "conjunction", "communication"],
    ["zero", "TEMPERATURE", "B1", "number", "natural world"],
    ["twelve", "", "A1", "number", ""],
    ["twenty", "NUMBER", "A1", "number", ""],
    ["two", "NUMBER", "A1", "number", ""],
    ["when", "AT WHAT TIME", "A2", "conjunction", ""],
    ["where", "POSITION", "A2", "conjunction", ""],
    ["while", "DURING", "A2", "conjunction", ""],
    ["unless", "", "B1", "conjunction", ""],
    ["until", "TIME", "B1", "preposition", ""],
    ["until", "DIRECTIONS", "B1", "preposition", ""],
    ["whenever", "EVERY TIME", "B1", "conjunction", ""],
    ["wherever", "EVERY PLACE", "B1", "conjunction", ""],
    ["whether", "IF", "B1", "conjunction", ""],
    ["yet", "", "B1", "conjunction", ""],
    ["when", "ALTHOUGH", "B2", "conjunction", ""],
    ["where", "PROCESS/ACTIVITY", "B2", "conjunction", ""],
    ...
    ["clichéd", "", "C2", "adjective", "communication"],
