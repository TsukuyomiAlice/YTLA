import unittest
import json
from core.classic.modules.module.dao.daoModulePersistence import DBConnector, Instance, get_content, insert_content, update_content
...
class TestDaoModulePersistence(unittest.TestCase):
    ...
    def test_3_get_last_content(self):
        ...
        from core.classic.modules.module.dao.daoModulePersistence import get_last_content
    ...
    def test_5_delete_content(self):
        ...
        from core.classic.modules.module.dao.daoModulePersistence import delete_content
