import unittest
from core.classic.modules import daoModules
from core.classic.modules.module.dao import Instance, add_module, update_module_detail, soft_delete_module
...
class TestDaoModules(unittest.TestCase):
    ...
    def test_3_activate_deactivate(self):
        ...
        from core.classic.modules.module.dao import deactivate_module, activate_module, check_module_active_status
