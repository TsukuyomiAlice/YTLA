...
import ModuleMainFrame from '@/core/modules/_type/layouts/ModuleMainFrame.vue'
import ModuleSubFrame from '@/core/modules/_type/layouts/ModuleSubFrame.vue'
...
@use '@/core/frame/styles/main-content-layer';
</style>
