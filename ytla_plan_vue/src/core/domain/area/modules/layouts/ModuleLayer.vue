...
import ModuleMainFrame from '@/core/domain/area/modules/layouts/ModuleMainFrame.vue'
import ModuleSubFrame from '@/core/domain/area/modules/layouts/ModuleSubFrame.vue'
...
@use '../../frame/styles/main-content-layer';
</style>
