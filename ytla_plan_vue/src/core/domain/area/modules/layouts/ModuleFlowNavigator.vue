...
import { type FrameType } from '@/core/domain/area/modules/composables/useModuleStepManager.ts'
...
import { useModuleStepManager } from '@/core/domain/area/modules/composables/useModuleStepManager.ts'
