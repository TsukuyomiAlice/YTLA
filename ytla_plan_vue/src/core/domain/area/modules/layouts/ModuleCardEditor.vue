    ...
    <div class="main-content">
      ...
      <div class="content-wrapper">
        ...
        <div class="action-column-bottom">
          ...
          >
            {{ $t('planManage.PlanDashBoardSub_00_100') }}
          </button>
          <button
            v-if="activeFlag === '0'"
          ...
          >
            {{ $t('planManage.PlanDashBoardSub_00_101') }}
          </button>
          <button
            class="rect-button red"
            @click="handleClose"
          >
            {{ $t('planManage.PlanDashBoardSub_00_102') }}
          </button>
        </div>
...
import type { BaseModule } from '@/core/domain/area/modules/types/moduleTypes.ts'
...
// 初始化编辑数据
import { useModuleCardEditor } from '@/core/domain/area/modules/composables/useModuleCardEditor.ts'
...
@use '../../cards/styles/card-component-button';
@use '../../cards/styles/card-component-icon';
@use '../../cards/styles/card-component-tags';
@use '../../cards/styles/card-component-text';
</style>
