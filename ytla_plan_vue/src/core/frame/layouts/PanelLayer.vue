...
import { useModuleLoader } from '@/core/modules/composables/useModuleLoader'
import { useModuleProcessStore } from '@/core/modules/stores/moduleProcessStore'
...
<style lang="scss">
@use '@/core/frame/styles/layout-variables' as vars;
