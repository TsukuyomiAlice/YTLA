      ...
      <nav class="left-nav">
        <button class="swap-btn" @click="toggleSwap">
          ...
          <span class="swap-text">
            {{ isSideBarSwapped ? $t(`frame.MainLayout_swap_btn_to_left`) : $t(`frame.MainLayout_swap_btn_to_right`) }}
          </span>
        </button>
...
import PanelLayer from '@/core/frame/_type/layouts/PanelLayer.vue'
import SideCardLayer from '@/core/sideCards/_type/layouts/SideCardLayer.vue'
import ModuleLayer from '@/core/modules/_type/layouts/ModuleLayer.vue'
...
import { useLayoutMode } from '@/core/frame/_type/composables/useLayoutMode.ts'
useLayoutMode()
