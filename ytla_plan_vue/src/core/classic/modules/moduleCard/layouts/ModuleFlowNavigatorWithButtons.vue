...
import { type FrameType } from '@/core/classic/modules/moduleCard/composables/useModuleStepManager.ts'
...
import { useModuleStepManager } from '@/core/classic/modules/moduleCard/composables/useModuleStepManager.ts'
