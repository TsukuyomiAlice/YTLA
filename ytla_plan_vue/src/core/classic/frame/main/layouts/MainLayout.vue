      ...
      <nav class="left-nav">
        <button class="swap-btn" @click="toggleSwap">
          ...
          <span class="swap-text">
            {{ isSideBarSwapped ? $t(`classic.frame.main.MainLayout_swap_btn_to_left`) : $t(`classic.frame.main.MainLayout_swap_btn_to_right`) }}
          </span>
        </button>
...
import { useLayoutMode } from '@/core/classic/frame/main/composables/useLayoutMode.ts'
useLayoutMode()
