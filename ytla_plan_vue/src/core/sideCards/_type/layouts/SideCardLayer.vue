...
import SideCardController from '@/core/sideCards/_type/layouts/SideCardController.vue'
import SideCardContainer from '@/core/sideCards/_type/layouts/SideCardContainer.vue'
...
@use 'layout-variables' as layout-variables;
