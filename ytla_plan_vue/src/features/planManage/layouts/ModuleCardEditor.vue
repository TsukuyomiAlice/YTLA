      ...
      <div class="content-wrapper">
        ...
        <div class="header">
          ...
          <div class="title-wrapper">
            ...
            <h3>{{ $t(`${moduleType}.type_name`) }}&nbsp&nbsp-&nbsp&nbsp{{ $t(`${moduleType}.${moduleSubType}_subtype_name`) }}</h3>
          </div>
        </div>
...
// 初始化编辑数据
import { useModuleCardEditor } from '@/features/planManage/composables/useModuleCardEditor.ts'
...
@use '@/features/planManage/styles/module-card-editor';
...
@use '@/core/frame/styles/card-component-text';
</style>
