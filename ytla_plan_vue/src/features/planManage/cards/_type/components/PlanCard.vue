...
import type { TagString } from '@/core/plans/_type/types/planTypes.ts'
...
import { usePlanCard } from '@/features/planManage/composables/usePlanCard.ts'
const {
  tagsArray,
  isPinned, handleDragStart, handleDragEnd, togglePin
} = usePlanCard(props, emit)

import { usePlanCardEditor } from '@/features/planManage/composables/usePlanCardEditor.ts'
const {
...
@use '@/features/planManage/styles/plan-card';
