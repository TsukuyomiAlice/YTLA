<template>
  <div v-if="activeFlag === '1'">
    ...
    <div class="top-section">
      <h1>{{ plan?.name }} - {{ $t('planManage.PlanDashBoardMain_00_000') }}</h1>
      <ReturnToPlanButton />
      &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="dashboard-layout">
      ...
      <div class="ungrouped-modules"
           ...
           @dragenter.prevent>
        <PlanModuleContainer
          :group-name="$t('planManage.PlanDashBoardMain_00_001')"
  ...
  <div v-if="activeFlag === '0'">
    <h1>{{ $t('planManage.PlanDashBoardMain_00_100') }}</h1>
  </div>
</template>

<script setup lang="ts">
import ReturnToPlanButton from '@/features/planManage/components/ui/ReturnToPlanButton.vue'
import AddPlanModuleGroupButton
  from '@/features/planManage/components/ui/AddPlanModuleGroupButton.vue'
import AddModuleButton from '@/features/planManage/components/ui/AddModuleButton.vue'
import { usePlanActiveFlag } from '@/features/planManage/composables/watchPlanActiveFlag.ts'
...
import PlanModuleContainer from '@/features/planManage/layouts/PlanModuleContainer.vue'
