<template>
  ...
  >
    ...
    <button
      class="action-button"
      @click.stop="startEditing(moduleId as number)"
    >
...
import { type TagString } from '@/core/modules/types/moduleTypes.ts'
...
import { useModuleCard } from '@/features/planManage/composables/useModuleCard.ts'

const {
  isDragging, handleDragStart, handleDragEnd,
  handleModuleClick, startEditing
} = useModuleCard(props, emit)
...
@use '@/features/planManage/styles/module-card';
