...
import { ScaffoldCardService, type ScaffoldCardResponse } from '../services/scaffoldCardService'

const API_BASE = import.meta.env.VITE_API_BASE
const scaffoldCardService = new ScaffoldCardService(API_BASE)

export const useScaffoldCardStore = defineStore('scaffoldCard', {
  state: () => ({
    isCore: false,
    typeName: '',
    subTypeName: '',
    ...
    result: null as ScaffoldCardResponse | null,
  }),
  actions: {
