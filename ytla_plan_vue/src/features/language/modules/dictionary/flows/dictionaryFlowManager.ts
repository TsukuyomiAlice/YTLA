...
dictionaryModuleFlowManager.registerFlow('dictionary-main-steps', [
  defineAsyncComponent(() => import('@/features/language/modules/dictionary/components/DictionaryMain_00.vue')),
])

dictionaryModuleFlowManager.registerFlow('dictionary-sub-steps', [
  defineAsyncComponent(() => import('@/features/language/modules/dictionary/components/DictionarySub_00.vue')),
])
