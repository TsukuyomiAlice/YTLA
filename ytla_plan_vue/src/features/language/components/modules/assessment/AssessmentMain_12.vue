...
import AssessmentNextButton from '@/features/language/components/ui/assessment/AssessmentNextButton.vue'
...
const handleNext = async () => {
  try {
    ...
    await assessmentStore.assessment2(planId, moduleId, selectedWords.value)
