...
matrixModuleFlowManager.registerFlow('matrix-main-steps', [
  defineAsyncComponent(() => import('@/features/mathematics/components/modules/matrix/MatrixMain_00.vue')),
])

matrixModuleFlowManager.registerFlow('matrix-sub-steps', [
  defineAsyncComponent(() => import('@/features/mathematics/components/modules/matrix/MatrixSub_00.vue')),
])
