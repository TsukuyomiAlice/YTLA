...
const registryModules = import.meta.glob('@/features/sample/cards/**/registries/registry.ts', { eager: true })

export const sampleCardConfig = buildCardRegistry(SideCard, registryModules) as sideCardRegistry
