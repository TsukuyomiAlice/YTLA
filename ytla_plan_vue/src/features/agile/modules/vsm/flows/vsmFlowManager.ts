...
vsmModuleFlowManager.registerFlow('vsm-main-steps', [
  defineAsyncComponent(() => import('@/features/agile/modules/vsm/components/VsmMain_00.vue')),
])

vsmModuleFlowManager.registerFlow('vsm-sub-steps', [
  defineAsyncComponent(() => import('@/features/agile/modules/vsm/components/VsmSub_00.vue')),
])
